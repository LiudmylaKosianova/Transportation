...
class VehicleTest {
	...
	void testRefuel() {
		...
		assertNotEquals(100, bike1.getGasRemained());
		jeep2.refuel(0);
		assertEquals(benz.getGasRemained(),jeep2.getGasRemained());
		jeep2.refuel(200);
		benz.refuel(2000);
		assertEquals(200, benz.getGasRemained());
	}
	...
	void testRun() {
		...
		// TODO write at least 3 additional test cases
		benz.run(5);
		assertEquals(benz.getGasRemained(),bike2.getGasRemained());
		benz.refuel(5);
		benz.run(10);
		assertEquals(0, benz.getGasRemained());
		benz.refuel(200);
		benz.run(19);
		assertEquals(10,benz.getGasRemained());
	}
	...
	void testToString() {
		...
		// TODO write at least 3 additional test cases 
		assertNotEquals("Car Benz", jeep1.toString());
		assertEquals("Car Benz", benz.toString());
		assertNotEquals("Bike Trek", bike2.toString());
